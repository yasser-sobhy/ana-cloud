...
public:
    ...
    */
    ...
    /** Used by FileServer to change file path to file's path on server */
    QByteArray setPath(QString newPath);
    ...
    */
    ...
    /** Get length of request parameters */
    int getParameterLength() const;

    /**
      Get the values of a HTTP request path token.
      @param token Name of the token
    */
    QByteArray getTokenValue(QByteArray token);

    /**
      Get all HTTP request path tokens.
    */
    QHash<QByteArray, QByteArray> *getTokens();

    /**
      Set the values of a HTTP request path tokens.
      @param var Path tokens of HTTP request path
    */
    void setTokens(QHash<QByteArray, QByteArray> *tokens);
...
private:
    ...
    /** Path tokens of the request */
    QHash<QByteArray,QByteArray> *pathTokens;
